...
export default {
  ...
  methods: {
    ...
    save() {
      this.request.post("/charity", this.form).then(res => {
        if (res.code === '200') {
    ...
    del(id) {
      this.request.delete("/charity/" + id).then(res => {
        if (res.code === '200') {
    ...
    delBatch() {
      ...
      this.request.post("/charity/del/batch", ids).then(res => {
        if (res.code === '200') {
