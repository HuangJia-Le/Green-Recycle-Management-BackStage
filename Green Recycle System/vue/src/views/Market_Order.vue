<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入公益团体" suffix-icon="el-icon-message" class="ml-5" v-model="company"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://' + serverIp + ':9090/order/import3'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="company" label="发货人"></el-table-column>
    ...
    <el-dialog title="订单信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="发货人">
          <el-select clearable v-model="form.company" placeholder="请选择发货人" style="width: 100%">
            <el-option v-for="item in admins" :key="item.name" :label="item.name" :value="item.nickname"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="订单物品">
          <el-select clearable v-model="form.charityItem" placeholder="请选择物品" style="width: 100%">
...
export default {
  ...
  methods: {
    load() {
      ...
      this.request.get("/order-state").then(res => {
        this.states = res.data
          ...
          this.request.get("/user/admin").then(res => {
    ...
    exp() {
      window.open(`http://${serverIp}:9090/order/export3`)
    },
