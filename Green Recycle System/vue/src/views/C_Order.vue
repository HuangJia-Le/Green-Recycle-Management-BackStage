<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="请输入捐赠物品" suffix-icon="el-icon-search" v-model="item"></el-input>
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="handleAdd">发布捐赠订单 <i class="el-icon-circle-plus-outline"></i></el-button>
      <el-popconfirm
          class="ml-5"
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="orderNum" label="订单重量"></el-table-column>
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/order/pageplus", {
        params: {
