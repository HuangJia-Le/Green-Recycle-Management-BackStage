<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="请输入回收物品" suffix-icon="el-icon-search" v-model="item"></el-input>
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="handleAdd">发布回收订单 <i class="el-icon-circle-plus-outline"></i></el-button>
      <el-popconfirm
          class="ml-5"
...
export default {
  ...
  methods: {
    load() {
      this.request.get("/order/pageplus1", {
        params: {
