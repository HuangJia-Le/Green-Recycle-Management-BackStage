<template>
  <div>
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入回收公司" suffix-icon="el-icon-message" class="ml-5" v-model="company"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://' + serverIp + ':9090/order/import2'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="company" label="回收公司"></el-table-column>
    ...
    <el-dialog title="订单信息" :visible.sync="dialogFormVisible" width="30%" >
      <el-form label-width="80px" size="small">
        ...
        <el-form-item label="回收公司">
          <el-select clearable v-model="form.company" placeholder="请选择回收公司" style="width: 100%">
            <el-option v-for="item in recycles" :key="item.name" :label="item.name" :value="item.nickname"></el-option>
          </el-select>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save() {
      this.form.type="回收订单"
      this.request.post("/order/user", this.form).then(res => {
        if (res.code === '200') {
    ...
    exp() {
      window.open(`http://${serverIp}:9090/order/export2`)
    },
