...
public class UserController {
    ...
    public Result password1(@RequestBody UserPasswordDT1 userPasswordDT1) {
        userService.updatePassword1(userPasswordDT1);
        return Result.success();
    }
